...
class Company extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            jobs:this.props.location.state.company.jobs
        }
    }
                                        ...
                                        {jobs.map(job => (
                                            <div className="section" key={job._id}>
                                                <div className="row">
                                                    ...
                                                    <button className="secondary-content btn-floating btn-small  waves-effect waves-light red" type="submit" onClick={() => { this.deleteJob(job._id) }}>
                                    ...
                                    <div className="card-action ">
                                        <div className="row">
                                            ...
                                            <div className="col s1 offset-s8">
                                                <button className=" btn-floating btn-large  waves-effect waves-light red" type="submit" onClick={() => { this.deleteCompany(company._id) }}>
                                                    <i className="material-icons">delete</i></button>
                                            </div>
                                        </div>
                                    </div>
